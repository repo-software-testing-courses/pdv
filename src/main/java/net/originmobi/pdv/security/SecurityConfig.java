    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable())
                .authorizeRequests(requests -> requests
                        ...
                        .antMatchers("/tributacao").hasRole("LISTA_TRIBUTAÇÃO")
                        .antMatchers("/tributacao").hasRole("CADASTRA_TRIBUTACAO")
                        .antMatchers("/regras").hasRole("CADATRAR_REGRA_TRIBUTACAO")
                        .antMatchers("/regras").hasRole("EXCLUIR_REGRA_TRIBUTACAO")
                        .antMatchers("/regras").hasRole("EDITAR_REGRA_TRIBUTACAO")
                        ...
                        .antMatchers("/cartaolancamentos").hasRole("GERENCIAR_CARTOES")
                        .antMatchers("/cartaolancamentos").hasRole("ANTECIPAR_CARTAO")
                        .antMatchers("/cartaolancamentos").hasRole("PROCESSAR_CARTAO")
